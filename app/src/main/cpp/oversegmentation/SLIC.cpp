...
//===========================================================================
void SLIC::DoRGBtoLABConversion(uint32_t * image,
	double*&					lvec,
	double*&					avec,
	double*&					bvec)
{
    ...
    for(int y=0;y<m_height;y++){
        for(int x=0;x<m_width;x++){
			...
			uint32_t pixel=(uint32_t )image[x+y*m_width];
			int red = (pixel & 0xff0000) >> 16;
			int green = (pixel & 0x00ff00) >> 8;
			int blue = (pixel & 0x0000ff) >> 0;

            RGB2LAB( red, green, blue, lvec[j], avec[j], bvec[j] );
            j++;
...
//===========================================================================
void SLIC::DoSuperpixelSegmentation_ForGivenSuperpixelSize(uint32_t* image,int width,int height,
	int*&						klabels,
	int&						numlabels,
    ...
    const double&               compactness)
{
    ...
    //--------------------------------------------------
    DoRGBtoLABConversion(image, m_lvec, m_avec, m_bvec);
...
/// The labels can be saved if needed using SaveSuperpixelLabels()
//===========================================================================
void SLIC::DoSuperpixelSegmentation_ForGivenNumberOfSuperpixels(uint32_t*  image,int width,int height,    int*&						klabels,
    int&						numlabels,
    ...
    const double&                                   compactness)//weight given to spatial distance
{
    ...
    DoSuperpixelSegmentation_ForGivenSuperpixelSize(image,width,height,klabels,numlabels,superpixelsize,compactness);
}
